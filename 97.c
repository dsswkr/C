/* 3점의 좌표를 지나는 원의 중심점과 지름을 구하시오. */
#include <stdio.h>
#include <math.h>
#define POINTS p3

int p1[] = { -10, 0, 0, 10, 0, -10 };	// 예제 데이터 1; 중심점 (0, 0), 지름 20
int p2[] = { 2, -1, 0, 1, 2, 3 };		// 예제 데이터 2; 중심점 (2,1), 지름 4
int p3[] = { 0, -5, 5, -10, 10, -5 };	// 예제 데이터 3; 중심점 (5,-5), 지름 10
